 ...
 *       &lt;sequence&gt;
 *         &lt;element name="runway" type="{http://icao.int/iwxxm/2021-2}RunwayDirectionPropertyType"/&gt;
 *         &lt;element name="meanRVR" type="{http://icao.int/iwxxm/2021-2}DistanceWithNilReasonType"/&gt;
 *         &lt;element name="meanRVROperator" type="{http://icao.int/iwxxm/2021-2}RelationalOperatorType" minOccurs="0"/&gt;
 *         &lt;element name="extension" type="{http://icao.int/iwxxm/2021-2}ExtensionType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *       &lt;attribute name="pastTendency" type="{http://icao.int/iwxxm/2021-2}VisualRangeTendencyType" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class AerodromeRunwayVisualRangeType {
    ...
    @XmlElementRef(name = "meanRVROperator", namespace = "http://icao.int/iwxxm/2021-2", type = JAXBElement.class, required = false)
