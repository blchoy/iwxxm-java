 ...
 *       &lt;sequence&gt;
 *         &lt;element name="prevailingVisibility" type="{http://icao.int/iwxxm/2021-2}DistanceWithNilReasonType"/&gt;
 *         &lt;element name="prevailingVisibilityOperator" type="{http://icao.int/iwxxm/2021-2}RelationalOperatorType" minOccurs="0"/&gt;
 *         &lt;element name="minimumVisibility" type="{http://icao.int/iwxxm/2021-2}DistanceWithNilReasonType" minOccurs="0"/&gt;
 *         &lt;element name="minimumVisibilityDirection" type="{http://icao.int/iwxxm/2021-2}AngleWithNilReasonType" minOccurs="0"/&gt;
...
public class AerodromeHorizontalVisibilityType {
    ...
    @XmlElementRef(name = "prevailingVisibilityOperator", namespace = "http://icao.int/iwxxm/2021-2", type = JAXBElement.class, required = false)
    protected JAXBElement<RelationalOperatorType> prevailingVisibilityOperator;
    @XmlElementRef(name = "minimumVisibility", namespace = "http://icao.int/iwxxm/2021-2", type = JAXBElement.class, required = false)
    protected JAXBElement<DistanceWithNilReasonType> minimumVisibility;
    @XmlElementRef(name = "minimumVisibilityDirection", namespace = "http://icao.int/iwxxm/2021-2", type = JAXBElement.class, required = false)
