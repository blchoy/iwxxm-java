 ...
 *       &lt;sequence&gt;
 *         &lt;element name="amount" type="{http://icao.int/iwxxm/2.1}CloudAmountReportedAtAerodromeType"/&gt;
 *         &lt;element name="base" type="{http://icao.int/iwxxm/2.1}DistanceWithNilReasonType"/&gt;
 *         &lt;element name="cloudType" type="{http://icao.int/iwxxm/2.1}SigConvectiveCloudTypeType" minOccurs="0"/&gt;
...
public class CloudLayerType {
    ...
    @XmlElementRef(name = "cloudType", namespace = "http://icao.int/iwxxm/2.1", type = JAXBElement.class, required = false)
