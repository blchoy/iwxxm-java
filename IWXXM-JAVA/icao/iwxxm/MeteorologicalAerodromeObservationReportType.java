 ...
 *         &lt;element name="aerodrome" type="{http://icao.int/iwxxm/2021-2}AirportHeliportPropertyType"/&gt;
 *         &lt;element name="observationTime" type="{http://www.opengis.net/gml/3.2}TimeInstantPropertyType"/&gt;
 *         &lt;element name="observation" type="{http://icao.int/iwxxm/2021-2}MeteorologicalAerodromeObservationPropertyType" minOccurs="0"/&gt;
 *         &lt;element name="trendForecast" type="{http://icao.int/iwxxm/2021-2}MeteorologicalAerodromeTrendForecastPropertyType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
    ...
    extends ReportType
{
    ...
    @XmlElementRef(name = "observation", namespace = "http://icao.int/iwxxm/2021-2", type = JAXBElement.class, required = false)
