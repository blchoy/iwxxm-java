 ...
 *       &lt;sequence&gt;
 *         &lt;element name="location" type="{http://icao.int/iwxxm/2021-2}AirspaceVolumePropertyType"/&gt;
 *         &lt;element name="locationIndicator" type="{http://icao.int/iwxxm/2021-2}SpaceWeatherLocationType"/&gt;
    ...
    extends AbstractFeatureType
{
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "location", namespace = "http://icao.int/iwxxm/2021-2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "locationIndicator", namespace = "http://icao.int/iwxxm/2021-2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "extension", namespace = "http://icao.int/iwxxm/2021-2", type = JAXBElement.class, required = false)
    })
     ...
     * line 124 of file:/hko/app/TOOL_iwxxm_schema_binding.2021/_schema/iwxxm/2021-2/spaceWxAdvisory.xsd
