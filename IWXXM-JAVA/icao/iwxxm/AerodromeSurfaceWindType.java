 ...
 *       &lt;sequence&gt;
 *         &lt;element name="meanWindDirection" type="{http://icao.int/iwxxm/2023-1}AngleWithNilReasonType" minOccurs="0"/&gt;
 *         &lt;element name="meanWindSpeed" type="{http://icao.int/iwxxm/2023-1}VelocityWithNilReasonType"/&gt;
 *         &lt;element name="meanWindSpeedOperator" type="{http://icao.int/iwxxm/2023-1}RelationalOperatorType" minOccurs="0"/&gt;
 *         &lt;element name="windGustSpeed" type="{http://icao.int/iwxxm/2023-1}VelocityWithNilReasonType" minOccurs="0"/&gt;
 *         &lt;element name="windGustSpeedOperator" type="{http://icao.int/iwxxm/2023-1}RelationalOperatorType" minOccurs="0"/&gt;
 *         &lt;element name="extremeClockwiseWindDirection" type="{http://icao.int/iwxxm/2023-1}AngleWithNilReasonType" minOccurs="0"/&gt;
 *         &lt;element name="extremeCounterClockwiseWindDirection" type="{http://icao.int/iwxxm/2023-1}AngleWithNilReasonType" minOccurs="0"/&gt;
...
public class AerodromeSurfaceWindType {
    ...
    @XmlElementRef(name = "meanWindDirection", namespace = "http://icao.int/iwxxm/2023-1", type = JAXBElement.class, required = false)
    protected JAXBElement<AngleWithNilReasonType> meanWindDirection;
    @XmlElement(required = true, nillable = true)
    protected VelocityWithNilReasonType meanWindSpeed;
    @XmlElementRef(name = "meanWindSpeedOperator", namespace = "http://icao.int/iwxxm/2023-1", type = JAXBElement.class, required = false)
    protected JAXBElement<RelationalOperatorType> meanWindSpeedOperator;
    @XmlElementRef(name = "windGustSpeed", namespace = "http://icao.int/iwxxm/2023-1", type = JAXBElement.class, required = false)
    protected JAXBElement<VelocityWithNilReasonType> windGustSpeed;
    @XmlElementRef(name = "windGustSpeedOperator", namespace = "http://icao.int/iwxxm/2023-1", type = JAXBElement.class, required = false)
    protected JAXBElement<RelationalOperatorType> windGustSpeedOperator;
    @XmlElementRef(name = "extremeClockwiseWindDirection", namespace = "http://icao.int/iwxxm/2023-1", type = JAXBElement.class, required = false)
    protected JAXBElement<AngleWithNilReasonType> extremeClockwiseWindDirection;
    @XmlElementRef(name = "extremeCounterClockwiseWindDirection", namespace = "http://icao.int/iwxxm/2023-1", type = JAXBElement.class, required = false)
