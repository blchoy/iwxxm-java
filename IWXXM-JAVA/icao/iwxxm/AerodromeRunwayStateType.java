 ...
 *       &lt;sequence&gt;
 *         &lt;element name="runway" type="{http://icao.int/iwxxm/2021-2}RunwayDirectionPropertyType" minOccurs="0"/&gt;
 *         &lt;element name="depositType" type="{http://icao.int/iwxxm/2021-2}RunwayDepositsType" minOccurs="0"/&gt;
 *         &lt;element name="contamination" type="{http://icao.int/iwxxm/2021-2}RunwayContaminationType" minOccurs="0"/&gt;
 *         &lt;element name="depthOfDeposit" type="{http://icao.int/iwxxm/2021-2}DistanceWithNilReasonType" minOccurs="0"/&gt;
 *         &lt;element name="estimatedSurfaceFrictionOrBrakingAction" type="{http://icao.int/iwxxm/2021-2}RunwayFrictionCoefficientType" minOccurs="0"/&gt;
...
public class AerodromeRunwayStateType {
    ...
    @XmlElementRef(name = "runway", namespace = "http://icao.int/iwxxm/2021-2", type = JAXBElement.class, required = false)
    protected JAXBElement<RunwayDirectionPropertyType> runway;
    @XmlElementRef(name = "depositType", namespace = "http://icao.int/iwxxm/2021-2", type = JAXBElement.class, required = false)
    protected JAXBElement<RunwayDepositsType> depositType;
    @XmlElementRef(name = "contamination", namespace = "http://icao.int/iwxxm/2021-2", type = JAXBElement.class, required = false)
    protected JAXBElement<RunwayContaminationType> contamination;
    @XmlElementRef(name = "depthOfDeposit", namespace = "http://icao.int/iwxxm/2021-2", type = JAXBElement.class, required = false)
    protected JAXBElement<DistanceWithNilReasonType> depthOfDeposit;
    @XmlElementRef(name = "estimatedSurfaceFrictionOrBrakingAction", namespace = "http://icao.int/iwxxm/2021-2", type = JAXBElement.class, required = false)
