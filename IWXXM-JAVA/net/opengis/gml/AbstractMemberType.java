...
@XmlSeeAlso({
    icao.iwxxm.TropicalCycloneSIGMETType.SupplementaryAnalysisCollection.class,
    icao.iwxxm.SIGMETType.AnalysisCollection.class,
    DictionaryEntryType.class,
    def.wmo.metce.MeasurementContextType.Measureand.class,
    def.wmo.metce.MeasurementContextType.MeasuringInterval.class,
    def.wmo.opm.RangeConstraintType.Value.class
})
